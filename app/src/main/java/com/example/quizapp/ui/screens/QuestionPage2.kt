...
fun QuestionPage2(
    ...
    Column(
        ...
        Row(
            ...
            SquareButton(
                text = "Czy java jest językiem statycznie typowanym?",
        ...
        Row(
            ...
            CircleButton(
                text = "To zależy",
                shape = CircleShape,
                onClick = { navController.navigate(route = Screen.QuestionPage3.route) }
            )
        }
        Row(
            modifier = Modifier.fillMaxWidth(),
            ...
            CircleButton(
                ...
                shape = CircleShape,
                onClick = {
                    navController.navigate(route = Screen.QuestionPage3.route)
                    counter.value++}
            )
        }
        Row(
